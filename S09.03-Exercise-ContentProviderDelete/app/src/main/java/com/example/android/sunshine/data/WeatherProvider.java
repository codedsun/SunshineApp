...
//  TODO (1) Implement the delete method of the ContentProvider
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        final SQLiteDatabase mSqliteDatabase = mOpenHelper.getWritableDatabase();
        int n;
        ...
        switch (match){
            ...
            case CODE_WEATHER :
                n = mSqliteDatabase.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                break;
