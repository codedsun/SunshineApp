...
//  TOO (2) Remove all the TextView declarations
     ...
     */
//  TOD (3) Declare an ActivityDetailBinding field called mDetailBinding
    private ActivityDetailBinding mDetailBinding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//      TOD (4) Remove the call to setContentView

//      TOD (5) Remove all the findViewById calls


//      TDO (6) Instantiate mDetailBinding using DataBindingUtil
