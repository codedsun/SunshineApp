...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        // TOD (1) Return the user's preferred location
        /** This will be implemented in a future lesson **/
...
//        return getDefaultWeatherLocation();
    ...
    public static boolean isMetric(Context context) {
        // TDO (2) Return true if the user's preference for units is metric, false otherwise
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String preffered = sharedPreferences.getString(context.getString(R.string.pref_units_key), context.getString(R.string.pref_units_metric));
        String metrics = context.getString(R.string.pref_units_metric);
        if(metrics.equals(preffered)){
            return true;
        }
        else
            return false;
