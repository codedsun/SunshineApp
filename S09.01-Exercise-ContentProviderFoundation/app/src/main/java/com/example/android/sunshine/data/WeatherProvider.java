...
//  TOD (5) Create static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to identify the URIs this ContentProvider can handle
    private static final int CODE_WEATHER = 100;

    private static final int CODE_WEATHER_WITH_DATE = 101;
//  TOO (7) Instantiate a static UriMatcher using the buildUriMatcher method

    public static final UriMatcher uriMatcher = buildUriMatcher();

    WeatherDbHelper mOpenHelper;

//  TOD () Write a method called buildUriMatcher where you match URI's to their numeric ID
...
//  TOD (1) Implement onCreate
    @Override
    public boolean onCreate() {
//      TOD (2) Within onCreate, instantiate our mOpenHelper
        mOpenHelper = new WeatherDbHelper(getContext());

//      TOD (3) Return true from onCreate to signify success performing setup
        return true;
    }
...
//  TODO (8) Provide an implementation for the query method
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (match){
            ...
            case CODE_WEATHER :
                cursors  = mOpenHelper.getReadableDatabase().query(WeatherContract.WeatherEntry.TABLE_NAME,
                    projection,
                    selection,
                    selectionArgs,
                    null,
            ...
            case CODE_WEATHER_WITH_DATE :
                ...
                String slc = WeatherContract.WeatherEntry.COLUMN_DATE+"=?";
        ...
        cursors.setNotificationUri(getContext().getContentResolver(), uri);
        return cursors;
