...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    public static int SUNSHINE_START_WINDOW_INHOURS = 3;
    public static int SUNSHINE_START_WINDOW_INSEC = (int)TimeUnit.HOURS.toSeconds(SUNSHINE_START_WINDOW_INHOURS);
    private static String syncTaskTag = "sync-task";
...
//  TODO (12) Create a method to schedule our periodic weather sync
     ...
     *                ContentResolver
     */
    static  void scheduleFirebaseJobService(Context context){

        Driver driver = new GooglePlayDriver(context);
        FirebaseJobDispatcher jobDispatcher = new FirebaseJobDispatcher(driver);
        Job job = jobDispatcher.newJobBuilder().setLifetime(Lifetime.FOREVER)
                .setService(SunshineFirebaseJobService.class)
                .setReplaceCurrent(true)
                .setRecurring(true)
                .setConstraints(Constraint.ON_ANY_NETWORK)
                .setTrigger(Trigger.executionWindow(0,SUNSHINE_START_WINDOW_INSEC)).build();
