...
//  TODO (18) Create a String array containing the names of the desired data columns from our ContentProvider
    public static String [] WEATHER_DETAIL_PROJECTION = new String []{};
...
//  TO(10) Remove the mWeatherDisplay TextView declaration
...
//      TDO (1) Use getData to get a reference to the URI passed with this Activity's Intent
//      TOO (17) Throw a NullPointerException if that URI is null
