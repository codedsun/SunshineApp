...
// TOD(1) Implement the proper LoaderCallbacks interface and the methods of that interface
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int LOADER_TASK = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        args.putString();
        getSupportLoaderManager().initLoader(LOADER_TASK, this);
        loadWeatherData();
    }
    ...
    // TDO (2) Within onCreateLoader, return a new AsyncTaskLoader that looks a lot like the existing FetchWeatherTask.
