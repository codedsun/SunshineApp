        ...
        switch (match){
            ...
            case CODE_WEATHER :
                for(int i =0; i< values.length;i++){
                    c = sqLiteDatabase.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, values[i]);
                    if(c==1) count++;
            ...
            default: throw new RuntimeException("Student, you need to implement the bulkInsert method!");
        }
        return (int)count;
